...
import com.optic.goodlike.providers.ImageProvider;
import com.optic.goodlike.providers.UsersProvider;
import com.optic.goodlike.utils.FileUtil;
...
public class EditProfileActivity extends AppCompatActivity {
    ...
    private void takePhoto(int requestCode) {
        ...
        if (takePictureIntent.resolveActivity(getPackageManager()) != null) {
            ...
            if (photoFile != null) {
                Uri photoUri = FileProvider.getUriForFile(EditProfileActivity.this, "com.optic.goodlike", photoFile);
